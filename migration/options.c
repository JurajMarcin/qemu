 ...
 * It needs to be disabled by default, because source side QEMU cannot receive
 * messages with unknown message type.
 */
#define DEFAULT_MIGRATE_POSTCOPY_RP_KEEPALIVE_PERIOD 0
